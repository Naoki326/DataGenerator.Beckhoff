...
{
	/// <summary>
	/// Name from PLC:STRING(63)
	/// PLCNamespace from PLC: 5.113.195.149.1.1:851
	/// Size: 64
	/// Comment from PLC: 
	/// <summary>
	[StructLayout(LayoutKind.Explicit)]
	public unsafe struct String64 : IPLCStructArray<byte>
	{
		[FieldOffset(0)]
		public fixed byte Array[64];
		...
		public unsafe void CopyFrom(ref byte[] sourceData)
		{
			...
			{
				Unsafe.CopyBlockUnaligned(ref Unsafe.As<String64, byte>(ref this), ref *(byte*)ptr, (uint)(sizeof(byte) * Length));
			}
		}
