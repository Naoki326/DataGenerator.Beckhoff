...
namespace PLCManager.Demo.Wrapper
{
	...
	/// Comment from PLC: 
	/// <summary>
	public partial class Tc2_System_ADSWRITEWrapper : BeckhoffStruct<Tc2_System_ADSWRITEWrapper, Tc2_System_ADSWRITE>
	{
		
		public Tc2_System_ADSWRITEWrapper(GetDataDel getDataDel, AdsClient client, uint indexGroup, uint indexOffset) : base(getDataDel, client, indexGroup, indexOffset)
		{
		}
		...
		public IBaseData<bool> WRITE { get; init; }
