...
{
	/// <summary>
	/// Name from PLC:Tc2_MC2.MC_MoveAbsolute
	/// PLCNamespace from PLC: 5.113.195.149.1.1:851
	/// Size: 1216
	/// Comment from PLC: 
	/// <summary>
	public partial class Tc2_MC2_MC_MoveAbsoluteWrapper : BeckhoffStruct<Tc2_MC2_MC_MoveAbsoluteWrapper, Tc2_MC2_MC_MoveAbsolute>
	{
		
		public Tc2_MC2_MC_MoveAbsoluteWrapper(GetDataDel getDataDel, AdsClient client, uint indexGroup, uint indexOffset) : base(getDataDel, client, indexGroup, indexOffset)
		{
		}
