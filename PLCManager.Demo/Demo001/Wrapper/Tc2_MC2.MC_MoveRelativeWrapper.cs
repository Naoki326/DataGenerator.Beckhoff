...
namespace PLCManager.Demo.Wrapper
{
	...
	/// Comment from PLC: 
	/// <summary>
	public partial class Tc2_MC2_MC_MoveRelativeWrapper : BeckhoffStruct<Tc2_MC2_MC_MoveRelativeWrapper, Tc2_MC2_MC_MoveRelative>
	{
		
		public Tc2_MC2_MC_MoveRelativeWrapper(GetDataDel getDataDel, AdsClient client, uint indexGroup, uint indexOffset) : base(getDataDel, client, indexGroup, indexOffset)
		{
		}
		
		public IBaseData<bool> Execute { get; init; }

		public IBaseData<double> Distance { get; init; }
